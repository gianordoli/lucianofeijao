...
const css = {
	code: ".image-container.svelte-10bemum{width:100%;margin:0 0 1em 0}.image-container.big.svelte-10bemum{grid-column-start:1;grid-column-end:span 5}.image-container.big.svelte-10bemum:nth-child(even){grid-column-start:6}",
	map: "{\"version\":3,\"file\":\"Image.svelte\",\"sources\":[\"Image.svelte\"],\"sourcesContent\":[\"<script>\\n  import 'lazysizes';  \\n  \\n  export let src;\\n  export let srcset;\\n  export let caption;\\n</script>\\n\\n<div class=\\\"image-container big\\\">\\n  <img alt=\\\"\\\" data-sizes=\\\"auto\\\" data-src=\\\"{src}\\\" data-srcset=\\\"{srcset}\\\" class=\\\"lazyload\\\" />\\n  <p>{caption}</p>\\n</div>\\n\\n<style>\\n\\t.image-container {\\n\\t\\twidth: 100%;\\n\\t\\t/* max-width: 400px; */\\n\\t\\tmargin: 0 0 1em 0;\\n\\t}\\n\\n\\t.image-container.big {\\n\\t\\tgrid-column-start: 1;\\n\\t\\tgrid-column-end: span 5;\\n\\t}\\n\\n\\t.image-container.big:nth-child(even) {\\n\\t\\tgrid-column-start: 6;\\n\\t}\\t  \\n</style>\\n\"],\"names\":[],\"mappings\":\"AAcC,gBAAgB,eAAC,CAAC,AACjB,KAAK,CAAE,IAAI,CAEX,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,AAClB,CAAC,AAED,gBAAgB,IAAI,eAAC,CAAC,AACrB,iBAAiB,CAAE,CAAC,CACpB,eAAe,CAAE,IAAI,CAAC,CAAC,AACxB,CAAC,AAED,gBAAgB,mBAAI,WAAW,IAAI,CAAC,AAAC,CAAC,AACrC,iBAAiB,CAAE,CAAC,AACrB,CAAC\"}"
};
...
const Image = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"image-container big svelte-10bemum"}"><img alt="${""}" data-sizes="${"auto"}"${add_attribute("data-src", src, 0)}${add_attribute("data-srcset", srcset, 0)} class="${"lazyload"}">
  <p>${escape(caption)}</p>
</div>`;
});
...
const Body = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	if ($$props.pageName === void 0 && $$bindings.pageName && pageName !== void 0) $$bindings.pageName(pageName);

	return `${each(page, ({ type, value }) => `${type === "image"
	? `${validate_component(Image, "Image").$$render($$result, Object.assign(value), {}, {})}`
	: `${type === "text"
		? `${validate_component(Text, "Text").$$render($$result, { value }, {}, {})}`
		: ``}`}`)}`;
});
...
const css$1 = {
	code: ".grid.svelte-17yb1c9{display:grid;grid-template-columns:repeat(12, 1fr);grid-gap:20px}",
	map: "{\"version\":3,\"file\":\"index.svelte\",\"sources\":[\"index.svelte\"],\"sourcesContent\":[\"<script>\\n  import Body from '../components/Body.svelte'\\n</script>\\n\\n<svelte:head>\\n\\t<title>Luciano Feijão</title>\\n</svelte:head>\\n\\n<div class=\\\"grid\\\">\\n  <Body pageName={'work'} />\\n</div>\\n\\n<style>\\n\\t\\n\\t.grid {\\n\\t\\tdisplay: grid;\\n\\t\\tgrid-template-columns: repeat(12, 1fr);\\n\\t\\tgrid-gap: 20px;\\n\\t}\\n</style>\"],\"names\":[],\"mappings\":\"AAcC,KAAK,eAAC,CAAC,AACN,OAAO,CAAE,IAAI,CACb,qBAAqB,CAAE,OAAO,EAAE,CAAC,CAAC,GAAG,CAAC,CACtC,QAAQ,CAAE,IAAI,AACf,CAAC\"}"
};

const Routes = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$1);

	return `${($$result.head += `${($$result.title = `<title>Luciano Feijão</title>`, "")}`, "")}

<div class="${"grid svelte-17yb1c9"}">${validate_component(Body, "Body").$$render($$result, { pageName: "work" }, {}, {})}
</div>`;
});
...
${validate_component(Body, "Body").$$render($$result, { pageName: "about" }, {}, {})}`;
});
